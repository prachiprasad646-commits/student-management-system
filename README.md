...
- ✅ **College Affiliation Check** - Verify if students belong to the college
- ✅ **IA Marks Analysis** - Best 2 IA marks calculation
- ✅ **Subject Classification** - IPCC/Normal/Lab subject identification
- ✅ **Exam Eligibility** - Check eligibility based on subject type
- ✅ **Pass/Fail Statistics** - Subject-wise and overall analysis
- ✅ **Topper Identification** - Top 3 in each subject and class
- ✅ **Grade Distribution** - Distinction/First Class/Second Class/Pass
- ✅ **Fee Management** - Track payments and send alerts
- ✅ **Attendance Tracking** - IA absentee analysis
- ✅ **Assignment Monitoring** - Track submission status
- ✅ **Student Search** - Search by USN
